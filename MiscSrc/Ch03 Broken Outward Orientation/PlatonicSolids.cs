...
namespace Interlocked
{
    public static class PlatonicSolids
    {
        ...
        // Add a smooth geodesic sphere to the mesh.
        public static void AddSmoothGeodesicSphere(this MeshGeometry3D mesh,
            ...
            int geodesic_level, double side_length, Transform3D transform)
        {
            ...
            // Add the Triangles to the mesh.
            mesh.AddSmoothTriangles(point_dict, triangles);
        }
